...
var _btnMenu = __webpack_require__(4);

var _btnMenu2 = _interopRequireDefault(_btnMenu);

var _widgetNav = __webpack_require__(5);

var _widgetNav2 = _interopRequireDefault(_widgetNav);
...
var widgetNav = function widgetNav() {
	...
	$('.widget--nav li').on('click', 'a', function (e) {
		var $menu_el = $(this);
		...
		if ($sub_menu.length && !$sub_menu.is(':visible')) {
			...
			$parent.toggleClass('expanded').children('.sub-menu').slideDown();

			$parent.siblings().removeClass('expanded').children('.sub-menu').slideUp();
		}
	});
};

exports.default = widgetNav;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var tables = function tables() {
	...
	$('.js-expand').on('click', function (e) {
		...
		$(this).parents('.table, .table-code').toggleClass('toggled');
	});
};
...
var tabs = function tabs() {
	...
	$('.tabs__nav label').on('click', function (event) {
		...
		$tabLink.parent().parent().add($targetTab).addClass(activeTabClass).siblings().removeClass(activeTabClass);
	});
};
